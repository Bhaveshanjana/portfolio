  ...
  return (
    <>
      ...
      <div className="px-6 ">
        ...
        <div className="bg-gray-800/80 flex flex-col items-center mx-auto rounded-sm w-[90%] sm:mt-4 sm:w-[40%]">
          <div className="">
            <img
              src={img}
              alt="uber.png"
          ...
          <div className="flex ml-2 items-center gap-3 pt-2 flex-wrap mb-2 text-white text-xs ">
            <div className="bg-gray-500 flex items-center rounded-sm">
              <img src={react} alt="react.png" className="w-5 ml-1" />
              <p className="px-1">React</p>
            </div>
            <div className="bg-gray-500 flex items-center rounded-sm">
              <img src={express} alt="react.png" className="w-5 ml-1" />
              <p className="px-1">ExpressJs</p>
            </div>
            <div className="bg-gray-500 flex items-center rounded-sm">
              <img src={node} alt="react.png" className="w-5 ml-1" />
              <p className="px-1">NodeJs</p>
            </div>
            <div className="bg-gray-500 flex items-center rounded-sm">
              <img src={mongo} alt="react.png" className="w-5 ml-1" />
              <p className="px-1">MongoDB</p>
            </div>
            <div className="bg-gray-500 flex items-center rounded-sm ">
              <img src={tailwind} alt="react.png" className="w-5 ml-1 " />

              <p className="px-1">TailwindCSS</p>
            </div>
            <div className="bg-gray-500 flex items-center rounded-sm">
              <img src={google} alt="react.png" className="w-5 ml-1" />
