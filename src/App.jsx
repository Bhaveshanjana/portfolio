    ...
    <div>
      ...
      <div className=" mx-auto md:pl-16 pl-6 w-full pt-12 sm:pt-16 space-y-6 ">
        ...
        <motion.p
          ...
          whileInView={"animate"}
          initial="initial"
          className=" text-sm sm:text-lg w-[296px] sm:w-[550px] md:w-[700px] lg:w-[700px] lg:text-xl text-white/80 tracking-wide"
        >
        ...
        <motion.div
          ...
          whileInView={"animate"}
          initial="initial"
          className="text-white flex gap-3 text-xl sm:text-2xl  cursor-pointer "
        >
      ...
      <div className=" bg-black/60 text-sm mt-4">
        <motion.h1
          ...
          initial="initial"
          whileInView="animate"
          className="text-center text-2xl text-white mb-2  border-b-emerald-200"
        >
          Get in touch
        </motion.h1>
        <motion.div
          ...
          initial="initial"
          whileInView="animate"
          className=" flex flex-col space-y-2 w-[80%] mx-auto lg:text-[15px]"
        >
